...
class BPSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.symbol_rate = symbol_rate = 48e3
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/mohamed/Bureau/PFE/audio/output_48khz_mono.wav', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'bpsk_modulated.complex', False)
        ...
        self.connect((self.root_raised_cosine_filter_0, 0), (self.low_pass_filter_0, 0))
    ...
    def set_symbol_rate(self, symbol_rate):
        ...
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, 48e3, 0.35, int(11 * self.samp_rate / self.symbol_rate)))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(3, self.samp_rate, 100000, 20000, firdes.WIN_HAMMING, 60))
